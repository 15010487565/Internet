...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.textsize_12);
        mHintTextSize = context.getResources().getDimensionPixelSize(R.dimen.textsize_26);
        ...
        if (attrs != null) {
            ...
            mTextColor = a.getColor(R.styleable.waveSideBar_textColorSideBar, mTextColor);
            mTextColorChoose = a.getColor(R.styleable.waveSideBar_chooseTextColor, mTextColorChoose);
            mTextSize = a.getDimensionPixelSize(R.styleable.waveSideBar_textSizeSideBar, mTextSize);
            ...
            mRadius = a.getDimensionPixelSize(R.styleable.waveSideBar_radiusSideBar, context.getResources().getDimensionPixelSize(R.dimen.margin_20));
            mCircleRadius = a.getDimensionPixelSize(R.styleable.waveSideBar_circleRadius, context.getResources().getDimensionPixelSize(R.dimen.height_25));
            a.recycle();
        }
